...
- [x] Landing page with signup (Buttondown subscribe form)
- [x] Welcome email sequence (single welcome email, copy in docs/welcome-email.md)
- [ ] First public edition (requires live API keys + Buttondown account)
- [x] Basic analytics (Buttondown built-in — open rates, clicks, subscriber growth)

### Technical Tasks

1. ~~Create landing page (simple, hosted on same domain)~~ Done: `generate_landing_page()` in web.py
2. ~~Implement subscriber signup flow~~ Done: Buttondown embed form
3. ~~Create welcome email~~ Done: docs/welcome-email.md (paste into Buttondown Automations)
4. ~~Add open rate / click tracking~~ Done: Buttondown handles this natively
5. Write launch announcement (pending)
